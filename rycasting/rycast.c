...
/*   Updated: 2025/08/29 15:27:17 by ababdoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	render_3d(t_game *game)
{
	...
	while (x < WINDOW_WIDTH)
	{
		...
		texX = calculate_tex_x(&ray, game, rayDirX, rayDirY);//calculate texture x coordinate
		draw_wall_column(game, &ray, x, texX);//draw the wall column
		x++;
	}
}
