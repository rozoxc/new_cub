...
/*   Updated: 2025/08/05 11:02:57 by ababdoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int ac, char **av)
{
    ...
    if (!game.player)
        return (1);
    game.view_mode = 0;
    game.texture = load_texture(&game, "/mnt/homes/ababdoul/Desktop/Cub3d/textures/WhatsApp-Image-2025-08-01-at-08.03.38-_1_.xpm");
    if (!game.texture)
        printf("warning !!\n");
    init_keys(&game);
