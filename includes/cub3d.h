...
# define MINIMAP_VIEW_RANGE 12
# define MINIMAP_TILE_SIZE 10
# define MINIMAP_OFFSET_X 20
# define MINIMAP_OFFSET_Y 20
# define MINIMAP_DOOR_CLOSED_COLOR 0x8B4513
# define MINIMAP_DOOR_OPEN_COLOR 0x90EE90
# define MINIMAP_WALL_COLOR 0xFFFFFF
# define MINIMAP_FLOOR_COLOR 0x333333
# define MINIMAP_PLAYER_COLOR 0xFF0000
# define MINIMAP_DIR_COLOR 0xFFFF00
...
void			draw_tile_by_type(t_game *game, char map_tile, int screen_x,
					int screen_y);
void			process_map_tile(t_game *game, t_minimap_data *mini,
					int map_x, int map_y);
